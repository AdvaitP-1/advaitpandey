...
const NeuFollowButton = () => {
  ...
  return (
    <div className="h-15 w-full max-w-72 bg-blue-800">
      <motion.a
        ref={ref}
        style={{ transform }}
        href="/resume.pdf"
        ...
        className="group flex h-full w-full items-center justify-between border-2 border-black bg-white px-8 text-xl font-semibold text-black"
      >
        <Copy>MY RESUME</Copy>
        <Arrow />
      </motion.a>
...
const Arrow = () => (
  <div className="pointer-events-none flex h-6 w-6 overflow-hidden text-2xl">
    <ArrowRight className="shrink-0 -translate-x-full text-blue-800 transition-transform duration-300 group-hover:translate-x-0" />
